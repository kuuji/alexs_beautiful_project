...
if [ ! -z $TRAVIS_TAG ]; then
  echo "deploy to k8s"
  ${HOME}/google-cloud-sdk/bin/kubectl set image deployment/alexs-beautiful-project alexs-beautiful-project=us.gcr.io/alexs_beautiful_project/alexs_beautiful_project:$TRAVIS_TAG
fi
